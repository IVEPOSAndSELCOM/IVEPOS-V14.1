...
public class IVEPOS_Hardware_Activation_Subscribe extends AppCompatActivity {


    String activation_code_program = "0000";
    String activation_code_address = "c:8b:fd:c4:2:bb";
...
//            if (date1.toString().equals("20161103")){
//                activation_code_address = "0:22:f4:3d:7f:7";
//            }
//        }

        final String da = "20161201";
            ...
            if (status.toString().equals("yes")){
                ...
                if (macAddress.toString().equals(activation_code_address)){
                    if (intdate <= Integer.parseInt(da)){
                        Intent intent = new Intent(IVEPOS_Hardware_Activation_Subscribe.this, MainActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                        //Toast.makeText(IVEPOS_Hardware_Activation.this, "same mac address 3", Toast.LENGTH_SHORT).show();
                    }else {
                        final Dialog dialog = new Dialog(IVEPOS_Hardware_Activation_Subscribe.this, R.style.timepicker_date_dialog);
...
//        dialog.show();
                ...
                if (activation_code.getText().toString().equals(activation_code_program)){
                    if (macAddress.toString().equals(activation_code_address)){
                        if (intdate <= Integer.parseInt(da)) {
                            ...
                            Dialog dialog1 = new Dialog(IVEPOS_Hardware_Activation_Subscribe.this, R.style.timepicker_date_dialog);
    ...
    public void alertas(String alerta) {
        ContextThemeWrapper wrapper = new ContextThemeWrapper(IVEPOS_Hardware_Activation_Subscribe.this, R.style.AppTheme);
