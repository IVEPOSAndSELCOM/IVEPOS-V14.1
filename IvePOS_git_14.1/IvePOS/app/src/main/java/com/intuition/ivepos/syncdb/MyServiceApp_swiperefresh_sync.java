...
public class MyServiceApp_swiperefresh_sync extends Service {


    public SQLiteDatabase db1 = null;
    private SQLiteDatabase db;
    private static com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh_sync.OnProgressUpdateListener progressListener;
    public static int page =1;
    public static final String CHANNEL_ID = "ForegroundServiceChannel";
    ArrayList<String> tableList = new ArrayList<String>();
    int tableIndex=0;
    public static void setOnProgressChangedListener(com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh_sync.OnProgressUpdateListener _listener) {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (c.moveToFirst()) {
                    while ( !c.isAfterLast() ) {
                        if (c.getString(0).equalsIgnoreCase("android-metadata") || c.getString(0).equalsIgnoreCase("items") ||
                                c.getString(0).equalsIgnoreCase("hotel") || c.getString(0).equalsIgnoreCase("taxes") ||
                                c.getString(0).equalsIgnoreCase("discount_details")) {
    ...
    public void downloadAppdata(){
        ...
        RequestQueue queue = Volley.newRequestQueue(com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh_sync.this);
        JsonObjectRequest sr = new JsonObjectRequest(
                com.android.volley.Request.Method.POST,
                WebserviceUrl+"downloadappdata_manual_sync.php",params,
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject responseString) {
                        ...
                        if(response.equalsIgnoreCase("success")){
                            ...
                            Toast.makeText(com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh_sync.this, "download failed", Toast.LENGTH_SHORT).show();
                        }
...
/*    sr.setRetryPolicy(new DefaultRetryPolicy(DefaultRetryPolicy.DEFAULT_TIMEOUT_MS,
    ...
    private void publishResults() {
        Intent intent = new Intent("com.intuition.ivepos.SettingsActivity.receiverapp");
    ...
    public void downloadAppdataitems(final String table){
        Log.e("MyServiceApp_swiperefresh_sync",getString(R.string.Button9));
        ...
        if(queue==null){
            queue = Volley.newRequestQueue(com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh_sync.this);
        }

        JsonObjectRequest sr = new JsonObjectRequest(
                com.android.volley.Request.Method.POST,
                WebserviceUrl+"pagination_manual_sync.php",params,
                new com.android.volley.Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject responseString) {
                        Log.e("MyServiceApp_swiperefresh_sync",getString(R.string.Button10));
                        String response= "";
                        JSONObject jsonObject=null;
                        try {
                            jsonObject=responseString;
                        ...
                        if(response.equalsIgnoreCase("success")){
                            ...
                            if(tableIndex<tableList.size()){
                                ...
                                Log.e("MyServiceApp_swiperefresh_sync","publishresults");
                                publishResults();
                                stopSelf();
                            }
...
/*    sr.setRetryPolicy(new DefaultRetryPolicy(DefaultRetryPolicy.DEFAULT_TIMEOUT_MS,
    ...
    public void parseJsonItems(JSONObject jsonObject,String table){
        ...
        Log.e("MyServiceApp_swiperefresh_sync",getString(R.string.Button11));
        db = openOrCreateDatabase("mydb_Appdata", Context.MODE_PRIVATE, null);
        try {
            JSONArray jsonArray=jsonObject.getJSONArray("appdata");
            for(int i=0;i<jsonArray.length();i++){
