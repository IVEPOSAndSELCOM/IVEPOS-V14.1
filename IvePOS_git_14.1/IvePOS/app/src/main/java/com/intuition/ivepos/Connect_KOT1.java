...
public class Connect_KOT1 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences sharedpreferences_select =  SplashScreenActivity_Selection.getDefaultSharedPreferencesMultiProcess(Connect_KOT1.this);
        ...
        Cursor cursor_dept_name = db.rawQuery("SELECT * FROM Name_Dept1", null);
        if (cursor_dept_name.moveToFirst()){
//            Toast.makeText(Connect_KOT1.this, "data si there", Toast.LENGTH_LONG).show();
            String name = cursor_dept_name.getString(1);
            dept_name.setText(name);
        }else {
//            Toast.makeText(Connect_KOT1.this, "no data", Toast.LENGTH_LONG).show();
        }
        cursor_dept_name.close();


        final Cursor cursor = db.rawQuery("SELECT * FROM IPConn_KOT1", null);
            ...
            public void onClick(View view) {
                if (account_selection.toString().equals("Dine")) {
                    ...
                    if (cursor3.moveToFirst()) {
                        ...
                        TextView tv = new TextView(Connect_KOT1.this);
                        tv.setText(lite_pro);

                        if (tv.getText().toString().equals("Lite")) {
                            Intent intent = new Intent(Connect_KOT1.this, BeveragesMenuFragment_Dine_l.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(intent);
                        }else {
                            Intent intent = new Intent(Connect_KOT1.this, BeveragesMenuFragment_Dine.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(intent);
                        }
                    }else {
                    ...
                    if (account_selection.toString().equals("Qsr")) {
                        Intent intent = new Intent(Connect_KOT1.this, BeveragesMenuFragment_Qsr.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                LoginActivity.this.finish();
                        startActivity(intent);
                    }else {
                        Intent intent = new Intent(Connect_KOT1.this, BeveragesMenuFragment_Retail.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                LoginActivity.this.finish();
                        startActivity(intent);
                    }
...
//                startActivity(intent);
        ...
        department_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog dialogauth = new Dialog(Connect_KOT1.this, R.style.timepicker_date_dialog);
                dialogauth.setContentView(R.layout.dialog_department_name);
                dialogauth.show();

                editText1 = (EditText) dialogauth.findViewById(R.id.editText1);
...
//                    Toast.makeText(Connect_KOT1.this, "no data", Toast.LENGTH_LONG).show();
                ...
                btncancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        donotshowKeyboard(Connect_KOT1.this);
                ...
                btnsave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        cv.put("dept1_name", editText1.getText().toString());
                        String where1 = "_id = '1' ";
//                        db.update("Name_Dept1", cv, where1, new String[]{});
        ...
        printer_selec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intenttt = new Intent(Connect_KOT1.this, SearchIPActivity_KOT1.class);
        ...
        item_selec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Connect_KOT1.this, KOT_MultiSelection_items.class);
...
//                Toast.makeText(Add_manage_ingredient_Activity.this, "3", Toast.LENGTH_LONG).show();
    ...
    class DownloadMusicfromInternetde extends AsyncTask<String, Void, Integer> {
        private final ProgressDialog dialog1_c = new ProgressDialog(Connect_KOT1.this, R.style.timepicker_date_dialog);
