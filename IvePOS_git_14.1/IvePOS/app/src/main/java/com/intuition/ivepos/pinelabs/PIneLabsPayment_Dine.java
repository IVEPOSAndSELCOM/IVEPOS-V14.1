...
public class PIneLabsPayment_Dine {
    ...
    public static BeveragesMenuFragment_Dine instance=null;
    public static ArrayList<PrintData> printDataList1;
    public static String methodid="";

    public void startPinelabsPayment(BeveragesMenuFragment_Dine instance1, Context ctx, String billno, String amt) {
        context=ctx;
        instance=instance1;
        billnumber=billno;
        amount=amt;
...
// process the response Json as required.
    ...
    public void printData(Context ctx, BeveragesMenuFragment_Dine instance1, ArrayList<PrintData> printDataList){
        methodid="1002";
