...
public class Office365_attachment_CustomerlistCSV {
    ...
    public Office365_attachment_CustomerlistCSV() {

    }

    public Office365_attachment_CustomerlistCSV(String fromEmail, String fromPassword,
