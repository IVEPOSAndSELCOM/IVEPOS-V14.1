...
public class PIneLabsPayment_Dine_l {
    ...
    public static BeveragesMenuFragment_Dine_l instance=null;
    public static ArrayList<PrintData> printDataList1;
    public static String methodid="";

    public void startPinelabsPayment(BeveragesMenuFragment_Dine_l instance1, Context ctx, String billno, String amt) {
        context=ctx;
        instance=instance1;
        billnumber=billno;
        amount=amt;
        ...
        public void handleMessage(Message msg) {
            try {
                ...
                if(methodId.equalsIgnoreCase("1001")){
                    ...
                    if(responseMessage.equalsIgnoreCase("APPROVED")){
                        ...
                        //  Toast.makeText(context,getString(R.string.setmessage5),Toast.LENGTH_LONG).show();

                        instance.builder.setMessage((R.string.setmessage5)+"").setTitle(R.string.failed1_title);

                        //Setting message manually and performing action on button click
                        instance.builder.setMessage((R.string.setmessage5)+"")
                                .setCancelable(false)
                        ...
                        instance.alert.setTitle((R.string.title8));
                        instance.alert.show();
...
// process the response Json as required.
    ...
    public void printData(Context ctx, BeveragesMenuFragment_Dine_l instance1, ArrayList<PrintData> printDataList){
        methodid="1002";
