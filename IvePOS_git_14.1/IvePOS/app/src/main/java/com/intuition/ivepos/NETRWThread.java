...
public class NETRWThread extends Thread {
    ...
    private static RecvCallBack1 callBack = null;
    private static final Object NULLLOCK = new Object();
    public static RxBuffer1 NETRXBuffer = new RxBuffer1(0x1000);
    ...
    public static void SetOnRecvCallBack(RecvCallBack1 callback) {
        synchronized (NULLLOCK) {
            callBack = callback;
        }
    }
