...
public class PIneLabsPayment_QSR {
    String tit;
    ...
    public static BeveragesMenuFragment_Qsr instance=null;
    public static ArrayList<PrintData> printDataList1;
    public static String methodid="";

    public void startPinelabsPayment(BeveragesMenuFragment_Qsr instance1, Context ctx, String billno, String amt) {
            ...
            try {
              ...
              if(methodId.equalsIgnoreCase("1001")){
                  ...
                  if(responseMessage.equalsIgnoreCase("APPROVED")){
                      ...
                      instance.alert.setTitle(R.string.failed1);
                      instance.alert.show();
...
// process the response Json as required.
    ...
    public void printData(Context ctx, BeveragesMenuFragment_Qsr instance1, ArrayList<PrintData> printDataList){
        methodid="1002";
