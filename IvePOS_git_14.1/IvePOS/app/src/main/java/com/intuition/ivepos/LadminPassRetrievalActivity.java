 ...
 */
public class LadminPassRetrievalActivity extends AppCompatActivity {

    LoginDataBaseAdapter loginDataBaseAdapter;
    TextView useroneusername, useronepassword, usertwousername, usertwopassword;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lacalallpasswords1);

        SharedPreferences sharedpreferences_select =  SplashScreenActivity_Selection.getDefaultSharedPreferencesMultiProcess(LadminPassRetrievalActivity.this);
        ...
        arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LadminPassRetrievalActivity.this, ForgotPasswordActivity.class);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(LadminPassRetrievalActivity.this, MainActivity.class);
//                startActivity(intent);
//            }
//        });
            ...
            public void onClick(View v) {
                ...
                if (account_selection.toString().equals("Dine") || account_selection.toString().equals(getString(R.string.app_name))) {
                    ...
                    if (account_selection.toString().equals("Qsr")) {
                        ...
                        Intent intent = new Intent(LadminPassRetrievalActivity.this, MainActivity_Retail.class);
                        startActivity(intent);
                        finish();
                    }
                }
...
//                startActivity(intent);
        ...
        user1pass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog = new Dialog(LadminPassRetrievalActivity.this, R.style.cust_dialog);
