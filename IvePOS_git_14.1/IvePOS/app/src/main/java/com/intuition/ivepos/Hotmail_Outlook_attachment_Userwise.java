...
public class Hotmail_Outlook_attachment_Userwise {
    ...
    public Hotmail_Outlook_attachment_Userwise() {

    }

    public Hotmail_Outlook_attachment_Userwise(String fromEmail, String fromPassword,
...
//        String filename = "sdcard/Download/IvePOS_items_report"+currentDateandTimee1+"_"+timee1+".csv";
        String filename = "sdcard/IVEPOS_reports/IVEPOS_seller_report/IvePOS_seller_report"+currentDateandTimee1+"_"+timee1+".csv";
