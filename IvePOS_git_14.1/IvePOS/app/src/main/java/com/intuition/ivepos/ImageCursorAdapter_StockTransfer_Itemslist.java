...
public class ImageCursorAdapter_StockTransfer_Itemslist extends SimpleCursorAdapter {
    ...
    public ImageCursorAdapter_StockTransfer_Itemslist(Context context, int layout, Cursor c, String[] from, int[] to) {
    ...
    public View getView(int pos, View inView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.dialog_stock_transfer_itemslist, null);
        }
        this.c.moveToPosition(pos);
        String firstName = this.c.getString(this.c.getColumnIndex("itemname"));
        String price = c.getString(c.getColumnIndex("add_qty_st"));

        String quantity = c.getString(c.getColumnIndex("price"));
