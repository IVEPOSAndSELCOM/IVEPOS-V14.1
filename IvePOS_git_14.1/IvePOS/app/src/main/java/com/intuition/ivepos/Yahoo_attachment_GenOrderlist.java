...
public class Yahoo_attachment_GenOrderlist {
    ...
    public Yahoo_attachment_GenOrderlist() {

    }

    public Yahoo_attachment_GenOrderlist(String fromEmail, String fromPassword,
