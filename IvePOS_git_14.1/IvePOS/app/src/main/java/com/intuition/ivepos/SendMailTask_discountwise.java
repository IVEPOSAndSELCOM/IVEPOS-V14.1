...
public class SendMailTask_discountwise extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_discountwise(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            GMail_discountwise androidEmail = new GMail_discountwise(args[0].toString(),
