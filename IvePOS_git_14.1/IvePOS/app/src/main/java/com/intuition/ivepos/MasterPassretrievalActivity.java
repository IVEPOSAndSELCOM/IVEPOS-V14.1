...
/**
 * Created by Rohithkumar on 6/1/2015.
 */
public class MasterPassretrievalActivity extends AppCompatActivity {

    Dialog dialog;
    TextView ladminusername, ladminpassword, useroneusername, useronepassword, usertwousername, usertwopassword;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.masterallpasswords1);

        SharedPreferences sharedpreferences_select =  SplashScreenActivity_Selection.getDefaultSharedPreferencesMultiProcess(MasterPassretrievalActivity.this);
        ...
        arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MasterPassretrievalActivity.this, ForgotPasswordActivity.class);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(MasterPassretrievalActivity.this, MainActivity.class);
//                startActivity(intent);
//            }
//        });

        Button gotohome = (Button)findViewById(R.id.gotomainpage1);
...
//                startActivity(intent);
                ...
                if (account_selection.toString().equals("Dine") || account_selection.toString().equals(getString(R.string.app_name))) {
                    ...
                    if (account_selection.toString().equals("Qsr")) {
                        ...
                        Intent intent = new Intent(MasterPassretrievalActivity.this, MainActivity_Retail.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        intent.putExtra("from","home");
                        startActivity(intent);
                    }
...
//                startActivity(intent);
        ...
        ladminpass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog = new Dialog(MasterPassretrievalActivity.this, R.style.cust_dialog);
