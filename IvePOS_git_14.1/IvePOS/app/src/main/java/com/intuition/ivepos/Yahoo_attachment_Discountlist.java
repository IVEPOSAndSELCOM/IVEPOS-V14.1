...
public class Yahoo_attachment_Discountlist {
    ...
    public Yahoo_attachment_Discountlist() {

    }

    public Yahoo_attachment_Discountlist(String fromEmail, String fromPassword,
