...
public class Category_list extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TextView editText1_filter = new TextView(Category_list.this);
        TextView editText2_filter = new TextView(Category_list.this);
        TextView editText1 = new TextView(Category_list.this);
        TextView editText11 = new TextView(Category_list.this);
        TextView editText2 = new TextView(Category_list.this);
        TextView editText22 = new TextView(Category_list.this);
        TextView editText_from_day_visible = new TextView(Category_list.this);
        TextView editText_from_day_hide = new TextView(Category_list.this);
        TextView editText_to_day_visible = new TextView(Category_list.this);
        TextView editText_to_day_hide = new TextView(Category_list.this);
        ...
        SharedPreferences sharedpreferences_select =  SplashScreenActivity_Selection.getDefaultSharedPreferencesMultiProcess(Category_list.this);
        ...
        donotshowKeyboard(Category_list.this);
...
//        downloadMusicfromInternet.execute(editText1_filter.getText().toString() + editText2_filter.getText().toString());
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TextView onee = (TextView) view.findViewById(R.id.category);
//                Toast.makeText(Category_list.this, onee.getText().toString(), Toast.LENGTH_LONG).show();

                Dialog dialog = new Dialog(Category_list.this, R.style.timepicker_date_dialog);
                ...
                TextView category_name = (TextView) dialog.findViewById(R.id.category_name);
                category_name.setText(onee.getText().toString());

                ListView listView = (ListView) dialog.findViewById(R.id.list);

                final String selectQuery = "SELECT * FROM Expenses_sales WHERE datetimee_new >= '"+player1name+"' AND datetimee_new <='"+player2name+"' AND category = '"+onee.getText().toString()+"'";
                ...
                SimpleCursorAdapter adapter = new SimpleCursorAdapter(Category_list.this, R.layout.dialog_category_expenses_listview, cursor1, fromFieldNames, toViewsID, 0);
        ...
        user_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i ==1) {
                    ...
                    final String selectQuery = "SELECT * FROM dummy_category ORDER BY category COLLATE NOCASE DESC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    ...
                    SimpleCursorAdapter adapter = new SimpleCursorAdapter(Category_list.this, R.layout.category_layout, cursor1, fromFieldNames, toViewsID, 0);
                    listView.setAdapter(adapter);
                    ...
                    final String selectQuery = "SELECT * FROM dummy_category ORDER BY category COLLATE NOCASE ASC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"category", "transactions", "amount"};
                    final int[] toViewsID = {R.id.category, R.id.no_of_transactions, R.id.amount};
        ...
        transactions_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i ==1) {
                    ...
                    final String selectQuery = "SELECT * FROM dummy_category ORDER BY CAST(transactions AS unsigned) DESC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"category", "transactions", "amount"};
                    final int[] toViewsID = {R.id.category, R.id.no_of_transactions, R.id.amount};
                    ...
                    final String selectQuery = "SELECT * FROM dummy_category ORDER BY CAST(transactions AS unsigned) ASC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"category", "transactions", "amount"};
                    final int[] toViewsID = {R.id.category, R.id.no_of_transactions, R.id.amount};
        ...
        amount_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i ==1) {
                    ...
                    final String selectQuery = "SELECT * FROM dummy_category ORDER BY CAST(amount AS unsigned) DESC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"category", "transactions", "amount"};
                    final int[] toViewsID = {R.id.category, R.id.no_of_transactions, R.id.amount};
                    ...
                    final String selectQuery = "SELECT * FROM dummy_category ORDER BY CAST(amount AS unsigned) ASC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"category", "transactions", "amount"};
                    final int[] toViewsID = {R.id.category, R.id.no_of_transactions, R.id.amount};
            ...
            public void onClick(View view) {
                ...
                spinnercat.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        hideKeyboard(Category_list.this);

                        final Dialog dialog1 = new Dialog(Category_list.this, R.style.notitle);
                        ...
                        final ArrayAdapter my_Adapterr = new ArrayAdapter(Category_list.this, R.layout.spinner_row,
                                my_arrayy);
...
//                                }
                        ...
                        popupSpinner.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                //Toast.makeText(Category_list.this, "Selected item: " + selectedSweet + " - " + position, Toast.LENGTH_SHORT).show();
                            }
                        });
                ...
                btnsave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (editText_expense_price.getText().toString().equals(".") || editText_expense_price.getText().toString().equals(".0")
                            ...
                            if (date1.length() == 11) {
//                    Toast.makeText(Category_list.this, "11 "+date1, Toast.LENGTH_LONG).show();
//                    Toast.makeText(Category_list.this, "11 "+date1, Toast.LENGTH_LONG).show();
                                String onetoeight = date1.substring(0, 13);
                                date1 = onetoeight + "1";
                            } else {
//                    Toast.makeText(Category_list.this, "12 "+date1, Toast.LENGTH_LONG).show();
//                    Toast.makeText(Category_list.this, "12 "+date1, Toast.LENGTH_LONG).show();
                            }
                            ...
                            if (editText_expense_name.getText().toString().equals("") || editText_expense_price.getText().toString().equals("")) {
                                ...
                                Toast.makeText(Category_list.this,
...
//                            final int[] toViewsID = {R.id.category, R.id.no_of_transactions, R.id.amount};
//                            ImageCursorAdapter_Category adapter = new ImageCursorAdapter_Category(Category_list.this, R.layout.category_layout, cursor1, fromFieldNames, toViewsID, player1name, player2name);
//                            listView.setAdapter(adapter);
...
//                            Toast.LENGTH_SHORT).show();
    ...
    public ArrayList<String> getTableValuesall() {
        ...
        try {
            ...
            Toast.makeText(Category_list.this, "Error encountered.",
                    Toast.LENGTH_LONG);
        }
        return my_array;
    }
...
//                dpd.show(HomeActivity.this.getFragmentManager(), "Datepickerdialog");
        ...
        editText_from_day_visible_dialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                android.app.TimePickerDialog timePickerDialog = new android.app.TimePickerDialog(Category_list.this, R.style.timepicker_date_dialog, timePickerListener_open_dialogue, hour, minute,
                        false);
...
//                dpd.show(HomeActivity.this.getFragmentManager(), "Datepickerdialog");
                ...
                dpd.setMaxDate(Calendar.getInstance());
                dpd.show(Category_list.this.getFragmentManager(), "Datepickerdialog");
                //clickcounts++;
    ...
    public void webservicequery_sales(final String webserviceQuery){
        ...
        SharedPreferences sharedpreferences = getDefaultSharedPreferencesMultiProcess(Category_list.this);
        ...
        RequestQueue queue;
        StringRequest sr1;
        // queue = Volley.newRequestQueue(Category_list.this);

        queue= RequestSingleton.getInstance(Category_list.this).getInstance();
...
//                            final String pwd = prefs.getString("password", "");
    ...
    class DownloadMusicfromInternet extends AsyncTask<String, Void, Integer> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Category_list.this, R.style.timepicker_date_dialog);
        ...
        protected Integer doInBackground(String... params) {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    Cursor cursor1 = db1.rawQuery("SELECT SUM(Price) FROM Expenses_sales WHERE category = '"+category+"' AND datetimee_new >= '"+player1name+"' AND datetimee_new <='"+player2name+"' GROUP BY category", null);
                    if (cursor1.moveToFirst()) {
                        icount1 = cursor1.getFloat(0);
                    }
                    cursor1.close();

                    Cursor cursor2 = db1.rawQuery("SELECT Count(*) FROM Expenses_sales WHERE category = '"+category+"' AND datetimee_new >= '"+player1name+"' AND datetimee_new <='"+player2name+"' GROUP BY category", null);
...
//            });
        ...
        protected void onPostExecute(Integer file_url) {
            ...
            final String selectQuery = "SELECT * FROM dummy_category";
