...
public class SendMailTask_Yahoo_homebill extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Yahoo_homebill(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Yahoo_homebill androidEmail = new Yahoo_homebill(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
