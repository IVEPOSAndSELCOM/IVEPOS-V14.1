...
public class SendMailTask_Hotmail_Outlook_attachment_kot_can extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Hotmail_Outlook_attachment_kot_can(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Hotmail_Outlook_attachment_kot_can androidEmail = new Hotmail_Outlook_attachment_kot_can(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
