...
public class SendMailTask_cancelwise extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_cancelwise(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            GMail_cancelwise androidEmail = new GMail_cancelwise(args[0].toString(),
