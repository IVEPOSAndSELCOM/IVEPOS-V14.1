...
public class Hotmail_Outlook_attachment_Expense {
    ...
    public Hotmail_Outlook_attachment_Expense() {

    }

    public Hotmail_Outlook_attachment_Expense(String fromEmail, String fromPassword,
...
//        String filename = "sdcard/Download/IvePOS_items_report"+currentDateandTimee1+"_"+timee1+".csv";
        String filename = "sdcard/IVEPOS_reports/IVEPOS_expenses_report/IvePOS_expenses_report"+currentDateandTimee1+"_"+timee1+".csv";
