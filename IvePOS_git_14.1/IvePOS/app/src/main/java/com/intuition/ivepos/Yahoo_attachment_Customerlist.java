...
public class Yahoo_attachment_Customerlist {
    ...
    public Yahoo_attachment_Customerlist() {

    }

    public Yahoo_attachment_Customerlist(String fromEmail, String fromPassword,
