...
public class Taxes_Multiselection_Items_update extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences sharedpreferences_select =  SplashScreenActivity_Selection.getDefaultSharedPreferencesMultiProcess(Taxes_Multiselection_Items_update.this);
...
//                    }else {
//
//                        TextView cat_value1 = new TextView(Taxes_Multiselection_Items_update.this);
    ...
    private ArrayList<Item> fetchGroupMembers(String groupId) {
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                TextView tax1_t = new TextView(Taxes_Multiselection_Items_update.this);
                tax1_t.setText(tax1);
                TextView tax2_t = new TextView(Taxes_Multiselection_Items_update.this);
                tax2_t.setText(tax2);
                TextView tax3_t = new TextView(Taxes_Multiselection_Items_update.this);
                tax3_t.setText(tax3);
                TextView tax4_t = new TextView(Taxes_Multiselection_Items_update.this);
                tax4_t.setText(tax4);
                TextView tax5_t = new TextView(Taxes_Multiselection_Items_update.this);
                tax5_t.setText(tax5);
...
//            progressbar.setVisibility(View.VISIBLE);
        ...
        protected void onPostExecute(Integer file_url) {
            ...
            ExpandableAdapter_update adapter = new ExpandableAdapter_update(Taxes_Multiselection_Items_update.this, expandableListView, groupList, selection);
