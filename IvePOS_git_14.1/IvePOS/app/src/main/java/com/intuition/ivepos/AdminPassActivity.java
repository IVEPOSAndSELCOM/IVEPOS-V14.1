 ...
 * Created by Rohithkumar on 1/6/2015.
 */
public class AdminPassActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.admin_chg_pwd1, null);

        LinearLayout relativeLayout = (LinearLayout)rootview.findViewById(R.id.masteradmin);
        ...
        LinearLayout relativeLayout1 = (LinearLayout)rootview.findViewById(R.id.localadmin);
        relativeLayout1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                frag = new AdminLadminPassActivity();
                fragTransaction = getFragmentManager().beginTransaction().replace(R.id.container, frag);
                fragTransaction.commit();
...
//                Toast.makeText(getActivity(), "hi", Toast.LENGTH_SHORT).show();
        ...
        Cursor access = db.rawQuery("SELECT * FROM LOGIN ", null);
        ...
        final Button button = (Button)rootview.findViewById(R.id.proceed_button);
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             //       db.update("LOGIN", contentValues, where1, new String[]{});
