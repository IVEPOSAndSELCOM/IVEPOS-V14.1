...
public class A4_Printer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvkot = new TextView(A4_Printer.this);
...
//        btn_create_pdf = (Button) findViewById(R.id.btn_create_pdf);
        ...
        createPDFFile(Common.getAppPath(A4_Printer.this)+"test_pdf.pdf");
...
/////////
            ...
            TextView ttv = new TextView(A4_Printer.this);
            ttv.setText(billtypea);

            TextView ttv1 = new TextView(A4_Printer.this);
...
//            }
            ...
            if (cursor9.moveToFirst()) {
                ...
                vbnm.close();
                TextView cx = new TextView(A4_Printer.this);
                cx.setText(assa1);
            ...
            if (ccursorr.moveToFirst()) {
                ...
                do {
                    ...
                    if (pq.equals(getString(R.string.action_item))) {
                        ...
                        TextView tv1 = new TextView(A4_Printer.this);
                        ...
                        TextView tv2 = new TextView(A4_Printer.this);
                        ...
                        TextView tv3 = new TextView(A4_Printer.this);
                        ...
                        if (modcursor.moveToFirst()) {
                            ...
                            if (name.length() > charlength) {
                                int print1 = 0;
//                                Toast.makeText(A4_Printer.this, getString(R.string.Button9), Toast.LENGTH_SHORT).show();

                                if (value.length() > quanlentha && name.length() > charlength) {
//                                    Toast.makeText(A4_Printer.this, getString(R.string.Button10), Toast.LENGTH_SHORT).show();
                                ...
                                if (value.length() <= quanlentha && name.length() > charlength) {
//                                    Toast.makeText(A4_Printer.this, getString(R.string.Button11), Toast.LENGTH_SHORT).show();
                                    String string1 = name.substring(0, charlength);
                                    String string2 = name.substring(charlength);
                                    if (print1 == 0) {
                                        addNewItemWithLeftAndRight(document, value + "*" + name, pricee + "/" + tototot, titleFont, titleFont);
...
//                                    Toast.makeText(A4_Printer.this, getString(R.string.Button5), Toast.LENGTH_SHORT).show();
                                    String string1quan = value.substring(0, quanlentha);
                                    String string2quan = value.substring(quanlentha);
                                    String string1 = name.substring(0, charlength);
                                ...
                                if (value.length() <= quanlentha && name.length() > charlength1) {
//                                    Toast.makeText(A4_Printer.this, "5", Toast.LENGTH_SHORT).show();
                                    String string1 = name.substring(0, charlength);
                                    String string2 = name.substring(charlength, charlength1);
                                    String string3 = name.substring(charlength1);
                                    if(print1 == 0) {
                                ...
                                if (ccursor.moveToFirst()) {
                                    ...
                                    TextView hsn_hsn = new TextView(A4_Printer.this);
                                    hsn_hsn.setText(hsn);
...
//                                Toast.makeText(A4_Printer.this, getString(R.string.Button7), Toast.LENGTH_SHORT).show();
                                if (value.length() > quanlentha) {
//                                    Toast.makeText(A4_Printer.this, getString(R.string.Button1), Toast.LENGTH_SHORT).show();
                                    String string1quan = value.substring(0, quanlentha);
                                    String string2quan = value.substring(quanlentha);
...
//                                    Toast.makeText(A4_Printer.this, getString(R.string.Button2), Toast.LENGTH_SHORT).show();
                                    addNewItemWithLeftAndRight(document, value+"*"+name, pricee+"/"+tototot, titleFont, titleFont);
                            ...
                            do {
                                ...
                                final TableRow tableRow11 = new TableRow(A4_Printer.this);
                                tableRow11.setLayoutParams(new TableLayout.LayoutParams(
                                        TableRow.LayoutParams.MATCH_PARENT,
                                        TableRow.LayoutParams.WRAP_CONTENT, 4.5f));

                                final TextView tvv = new TextView(A4_Printer.this);
                                ...
                                TextView tv4 = new TextView(A4_Printer.this);
                                ...
                                TextView tv5 = new TextView(A4_Printer.this);
                                //lp2 = new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT, TableRow.LayoutParams.WRAP_CONTENT);
                                ...
                                TextView tv6 = new TextView(A4_Printer.this);
                                //lp2 = new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT, TableRow.LayoutParams.WRAP_CONTENT);
                                ...
                                final TextView tv7 = new TextView(A4_Printer.this);
                                ...
                                tv8 = new TextView(A4_Printer.this);
                            ...
                            if (name.length() > charlength) {
//                                Toast.makeText(A4_Printer.this, "10", Toast.LENGTH_SHORT).show();
                                int print1 = 0;
                                if (value.length() > quanlentha && name.length() > charlength) {
//                                    Toast.makeText(A4_Printer.this, "11", Toast.LENGTH_SHORT).show();
                                    String string1quan = value.substring(0, quanlentha);
                                    String string2quan = value.substring(quanlentha);
                                    String string1 = name.substring(0, charlength);
                                    String string2 = name.substring(charlength);
                                ...
                                if (value.length() <= quanlentha && name.length() > charlength) {
//                                    Toast.makeText(A4_Printer.this, "12", Toast.LENGTH_SHORT).show();
                                    String string1 = name.substring(0, charlength);
                                    String string2 = name.substring(charlength);
                                    if (print1 == 0) {
                                        addNewItemWithLeftAndRight(document, value + "*" + name, pricee + "/" + tototot, titleFont, titleFont);
...
////////////////////////////////////////////////
                                if (value.length() > quanlentha && name.length() > charlength1) {
//                                    Toast.makeText(A4_Printer.this, "13", Toast.LENGTH_SHORT).show();
                                    String string1quan = value.substring(0, quanlentha);
                                    String string2quan = value.substring(quanlentha);
                                    String string1 = name.substring(0, charlength);
                                    String string2 = name.substring(charlength, charlength1);
                                ...
                                if (value.length() <= quanlentha && name.length() > charlength1) {
//                                    Toast.makeText(A4_Printer.this, "14", Toast.LENGTH_SHORT).show();
                                    String string1 = name.substring(0, charlength);
                                    String string2 = name.substring(charlength, charlength1);
                                    String string3 = name.substring(charlength1);
                                    if (print1 == 0) {
                                ...
                                if (value.length() > quanlentha) {
//                                    Toast.makeText(A4_Printer.this, "15", Toast.LENGTH_SHORT).show();
                                    String string1quan = value.substring(0, quanlentha);
                                    String string2quan = value.substring(quanlentha);
                                    addNewItemWithLeftAndRight(document, value+"*"+name, pricee+"/"+tototot, titleFont, titleFont);
                                } else {
//                                    Toast.makeText(A4_Printer.this, "16", Toast.LENGTH_SHORT).show();
                                    addNewItemWithLeftAndRight(document, value+"*"+name, pricee+"/"+tototot, titleFont, titleFont);
                                }
...
/////////////////////////tax
            TableLayout tableLayout1 = new TableLayout(A4_Printer.this);
            ...
            if (ccursor.moveToFirst()) {
                ...
                do {
                    ...
                    TextView v = new TextView(A4_Printer.this);
                    v.setText(value);

                    TextView v1 = new TextView(A4_Printer.this);
                    v1.setText(name);
                    if (v.getText().toString().equals("0") || v1.getText().toString().equals("NONE") || v1.getText().toString().equals("None") || v.getText().toString().equals("0.0")
                        ...
                        TextView tvv = new TextView(A4_Printer.this);
                        ...
                        TextView textView1 = new TextView(A4_Printer.this);
...
//                                Toast.makeText(A4_Printer.this, "a "+mTextView.getText().toString(), Toast.LENGTH_LONG).show();
...
//                                                Toast.makeText(A4_Printer.this, "b " + mTextView2.getText().toString()+" "+sum, Toast.LENGTH_LONG).show();
                            }
                        } else {
                            if (mTextView.getText().toString().equals(mTextView1.getText().toString())) {
                                groupList.add(mTextView.getText().toString());
                                sum_p = sum_p+Float.parseFloat(mTextView2.getText().toString());
//                                                Toast.makeText(A4_Printer.this, "c " + mTextView2.getText().toString()+" "+sum, Toast.LENGTH_LONG).show();
                            }
                        }
                    }
//                    Toast.makeText(A4_Printer.this, "aa "+mTextView.getText().toString() +" "+sum_p, Toast.LENGTH_LONG).show();
...
//                    Toast.makeText(A4_Printer.this, " "+mod2, Toast.LENGTH_LONG).show();
...
//            Toast.makeText(A4_Printer.this, "user id there", Toast.LENGTH_LONG).show();
                ...
                TextView hid = new TextView(A4_Printer.this);
                hid.setText(proc);
...
//                                for (int i1 = 54; i1<69; i1++) {
                        ...
                        row.setLayoutParams(new TableLayout.LayoutParams(
                                TableRow.LayoutParams.MATCH_PARENT,
                                TableRow.LayoutParams.WRAP_CONTENT, 4.5f));
//                                    TextView tv33 = new TextView(A4_Printer.this);;
                        TableRow.LayoutParams lp, lp1, lp2;
...
//                String v = na;
                        ...
                        tv2.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
                        row.addView(tv2);
//                    Toast.makeText(A4_Printer.this, "hiii "+na38 + " @ " + us_name1.getString(i1) + "%", Toast.LENGTH_LONG).show();

                        TextView textView1 = new TextView(A4_Printer.this);
                        textView1.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
                        row.addView(textView1);

//                    Toast.makeText(A4_Printer.this, " "+i1 + " @ " + value1 + "%", Toast.LENGTH_LONG).show();
...
//                    Toast.makeText(A4_Printer.this, "11 " + String.valueOf(tota1), Toast.LENGTH_LONG).show();
                        ...
                        if (tv33.getText().toString().equals("0") || tv33.getText().toString().equals("0.0") || tv33.getText().toString().equals("0.00")
                            ...
                            tableLayout1.addView(row);
//                        Toast.makeText(A4_Printer.this, "22 " + us_name1.getString(i2) + " @ " + us_name1.getString(i1) + "%" + "---" + String.valueOf(tota1), Toast.LENGTH_LONG).show();
...
//            Toast.makeText(A4_Printer.this, "user id not there", Toast.LENGTH_LONG).show();
                Cursor cursorr = null;
                if (paymmethoda.equals("  Dine-in") || paymmethoda.equals(getString(R.string.general)) || paymmethoda.equals("  Others")) {
                    cursorr = db1.rawQuery("Select * from Taxes WHERE taxtype = 'Globaltax' AND tax1 = 'dine_in'", null);//replace to cursor = dbHelper.fetchAllHotels();
                }
...
//            Toast.makeText(this, getString(R.string.title41), Toast.LENGTH_LONG).show();
    ...
    private void printPDF() {
        ...
        try {
            PrintDocumentAdapter printDocumentAdapter = new PdfDocumentAdapter(A4_Printer.this, Common.getAppPath(A4_Printer.this)+"test_pdf.pdf");
...
//        Toast.makeText(A4_Printer.this, "resume", Toast.LENGTH_SHORT).show();
        if (i == 1) {
//            Toast.makeText(A4_Printer.this, "close", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        super.onBackPressed();
//        Toast.makeText(A4_Printer.this, "back pressed", Toast.LENGTH_SHORT).show();
        i = 1;
//        A4_Printer.this.finish();
    }
}
