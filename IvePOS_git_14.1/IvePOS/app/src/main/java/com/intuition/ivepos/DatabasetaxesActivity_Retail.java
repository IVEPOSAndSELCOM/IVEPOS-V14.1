...
public class DatabasetaxesActivity_Retail extends Fragment implements ReceiveListener {
    ...
    public DatabasetaxesActivity_Retail() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_multi_taxes1_retail, null);
...
//                frag = new DatabasetaxesActivity_Retail();
...
//                        final byte[] item_content6 = cursor.getBlob(cursor.getColumnIndexOrThrow("image"));
                        ...
                        if (allrows2.moveToFirst()) {
                            ...
                            dialog.setContentView(R.layout.fragment_update_tax_retail);
                            dialog.setCanceledOnTouchOutside(false);
                            dialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);

                            dialog.show();
//                        TextView Id = (TextView)dialog.findViewById(R.id.editText4);
//                        EditText iname = (EditText)dialog.findViewById(R.id.editText1);
//                        EditText iprice = (EditText)dialog.findViewById(R.id.editText2);
//                        EditText iquan = (EditText)dialog.findViewById(R.id.editText3);
                            //dialogC4_id = (Spinner)dialog.findViewById(R.id.chocolate_spinner);
                            //dialogC5_id = (Spinner)dialog.findViewById(R.id.)
...
//                        }
//                        allrows.close();
//                        ArrayAdapter my_Adapter = new ArrayAdapter(getActivity(), R.layout.spinner_row,
//                                my_array);
//                        dialogC4_id.setAdapter(my_Adapter);
