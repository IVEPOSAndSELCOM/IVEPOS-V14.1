...
public class NewStoreActivity_OTP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedpreferences_select =  getDefaultSharedPreferencesMultiProcess(NewStoreActivity_OTP.this);
                    ...
                    if(ch_storespecific.isChecked()){
                        ...
                        if(et_email.getText().toString().equalsIgnoreCase("")){
                            ...
                            if(et_password.getText().toString().equalsIgnoreCase(et_confirmpwd.getText().toString())){
                                ...
                                Toast.makeText(NewStoreActivity_OTP.this, "Confirm password is not same as password", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }else {
                        newStore();
    ...
    public void newStorespecific() {
        ...
        System.out.println("store details "+email+" "+password+" "+company+" "+store);
