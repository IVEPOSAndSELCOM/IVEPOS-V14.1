...
public class Office365_attachment_Cancellist {
    ...
    public Office365_attachment_Cancellist() {

    }

    public Office365_attachment_Cancellist(String fromEmail, String fromPassword,
