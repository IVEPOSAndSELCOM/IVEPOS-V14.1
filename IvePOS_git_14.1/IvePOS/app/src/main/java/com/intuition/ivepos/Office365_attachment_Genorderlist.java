...
public class Office365_attachment_Genorderlist {
    ...
    public Office365_attachment_Genorderlist() {

    }

    public Office365_attachment_Genorderlist(String fromEmail, String fromPassword,
