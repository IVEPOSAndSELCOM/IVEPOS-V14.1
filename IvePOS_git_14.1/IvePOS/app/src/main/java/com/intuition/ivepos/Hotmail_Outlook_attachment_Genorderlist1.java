...
public class Hotmail_Outlook_attachment_Genorderlist1 {

    final String emailPort = "587";// gmail's smtp port
    final String smtpAuth = "true";
    final String starttls = "true";
    final String emailHost = "smtp.live.com";
    ...
    public Hotmail_Outlook_attachment_Genorderlist1() {

    }

    public Hotmail_Outlook_attachment_Genorderlist1(String fromEmail, String fromPassword,
        ...
        Log.i("Hotmail_Outlook", "Mail server properties set.");
    }
    ...
    public MimeMessage createEmailMessage() throws AddressException,
        ...
        for (String toEmail : toEmailList) {
            Log.i("Hotmail_Outlook","toEmail: "+toEmail);
...
//        String filename = "sdcard/Download/IvePOS_items_report"+currentDateandTimee1+"_"+timee1+".csv";
        String filename = "sdcard/IVEPOS_reports/IVEPOS_Billwise_items_report/IvePOS_Billwise_items_report"+currentDateandTimee1+"_"+timee1+".csv";
//        String filename = "sdcard/IVEPOS_reports/IVEPOS_sales_report/IvePOS_sales_report"+currentDateandTimee1+"_"+timee1+".csv";
...
//        emailMessage.setContent(emailBody, "text/html");// for a html email
        ...
        Log.i("Hotmail_Outlook", "Email Message created.");
        return emailMessage;
    }
...
//        try {
        ...
        Log.i("Hotmail_Outlook","allrecipients: "+emailMessage.getAllRecipients());
        transport.sendMessage(emailMessage, emailMessage.getAllRecipients());
        transport.close();
        Log.i("Hotmail_Outlook", "Email sent successfully.");
//        }catch (Exception e){
