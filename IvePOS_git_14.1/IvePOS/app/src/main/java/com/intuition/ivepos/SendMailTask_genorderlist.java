...
public class SendMailTask_genorderlist extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_genorderlist(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            GMail_genorderlist androidEmail = new GMail_genorderlist(args[0].toString(),
