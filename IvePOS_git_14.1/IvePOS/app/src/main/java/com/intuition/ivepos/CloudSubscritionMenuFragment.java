 ...
 * Created by Rohithkumar on 1/6/2015.
 */
public class CloudSubscritionMenuFragment extends Fragment {
    ...
    public  CloudSubscritionMenuFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cloudsubscriptionlayout , container, false);
...
//            startActivity(intent);
            ...
            if (cursor.moveToFirst()) {
                String pt = cursor.getString(9);
                if (pt.toString().equals("yes")){
//                    frag = new SubscriptionActivity();
