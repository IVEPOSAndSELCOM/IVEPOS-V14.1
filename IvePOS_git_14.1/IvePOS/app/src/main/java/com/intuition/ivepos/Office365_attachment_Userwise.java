...
public class Office365_attachment_Userwise {
    ...
    public Office365_attachment_Userwise() {

    }

    public Office365_attachment_Userwise(String fromEmail, String fromPassword,
