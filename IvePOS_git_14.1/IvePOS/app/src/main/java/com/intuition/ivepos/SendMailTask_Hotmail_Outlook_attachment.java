...
public class SendMailTask_Hotmail_Outlook_attachment extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Hotmail_Outlook_attachment(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Hotmail_Outlook_attachment androidEmail = new Hotmail_Outlook_attachment(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
