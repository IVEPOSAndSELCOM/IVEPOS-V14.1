...
public class SendMailTask_genorderlist1 extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_genorderlist1(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            GMail_genorderlist1 androidEmail = new GMail_genorderlist1(args[0].toString(),
