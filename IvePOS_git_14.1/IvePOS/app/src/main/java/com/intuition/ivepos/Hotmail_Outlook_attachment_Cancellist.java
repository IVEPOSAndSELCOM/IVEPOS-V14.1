...
public class Hotmail_Outlook_attachment_Cancellist {
    ...
    public Hotmail_Outlook_attachment_Cancellist() {

    }

    public Hotmail_Outlook_attachment_Cancellist(String fromEmail, String fromPassword,
...
//        String filename = "sdcard/Download/IvePOS_items_report"+currentDateandTimee1+"_"+timee1+".csv";
        String filename = "sdcard/IVEPOS_reports/IVEPOS_refunds_report/IvePOS_refunds_report"+currentDateandTimee1+"_"+timee1+".csv";
