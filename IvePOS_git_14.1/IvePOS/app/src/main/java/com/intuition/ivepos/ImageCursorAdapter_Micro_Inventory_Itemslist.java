...
public class ImageCursorAdapter_Micro_Inventory_Itemslist extends SimpleCursorAdapter {
    ...
    public ImageCursorAdapter_Micro_Inventory_Itemslist(Context context, int layout, Cursor c, String[] from, int[] to) {
    ...
    public View getView(int pos, View inView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.dialog_micro_inventory_indent_itemslist, null);
        }
        this.c.moveToPosition(pos);
        String firstName = this.c.getString(this.c.getColumnIndex("ingredient_name"));
        String price = c.getString(c.getColumnIndex("add_qty"));

        String quantity = c.getString(c.getColumnIndex("indiv_price_temp"));
        String str_unit = c.getString(c.getColumnIndex("unit"));
