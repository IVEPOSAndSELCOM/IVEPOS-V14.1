...
public class SendMailTask_Hotmail_Outlook_attachment_Taxlist extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Hotmail_Outlook_attachment_Taxlist(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Hotmail_Outlook_attachment_Taxlist androidEmail = new Hotmail_Outlook_attachment_Taxlist(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
