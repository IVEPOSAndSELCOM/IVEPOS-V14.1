...
public class ImageCursorAdapter_Micro_Inventory_Itemslist1 extends SimpleCursorAdapter {
    ...
    public ImageCursorAdapter_Micro_Inventory_Itemslist1(Context context, int layout, Cursor c, String[] from, int[] to) {
