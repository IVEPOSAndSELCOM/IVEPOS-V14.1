...
public class SendMailTask_Office365_Online_order_form extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Office365_Online_order_form(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Office365_Online_order_form androidEmail = new Office365_Online_order_form(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
