...
public class Weighing_Scale_Configuration_Retail extends AppCompatActivity implements BLEControllerCallback
{
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    protected void onPause()
    {
        ...
        BLEController TheBleControllerL = BeveragesMenuFragment_Retail.BLEControllerM;
    ...
    public void onResume()
    {
        ...
        DevicesListM.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Toast.makeText(Weighing_Scale_Configuration_Retail.this, " "+DeviceNameL, Toast.LENGTH_LONG).show();
...
//        Intent intent = new Intent(this, BeveragesMenuFragment_Retail.class);
