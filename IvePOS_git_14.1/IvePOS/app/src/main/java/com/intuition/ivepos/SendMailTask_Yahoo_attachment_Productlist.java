...
public class SendMailTask_Yahoo_attachment_Productlist extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Yahoo_attachment_Productlist(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Yahoo_attachment_Productlist androidEmail = new Yahoo_attachment_Productlist(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
