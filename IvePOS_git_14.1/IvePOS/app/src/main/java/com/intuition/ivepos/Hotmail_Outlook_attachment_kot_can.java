...
public class Hotmail_Outlook_attachment_kot_can {
    ...
    public Hotmail_Outlook_attachment_kot_can() {

    }

    public Hotmail_Outlook_attachment_kot_can(String fromEmail, String fromPassword,
