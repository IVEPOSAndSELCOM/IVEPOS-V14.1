...
public class MyServiceApp_swiperefresh extends Service {


    public SQLiteDatabase db1 = null;
    private SQLiteDatabase db;
    private static com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh.OnProgressUpdateListener progressListener;
    public static int page =1;
    public static final String CHANNEL_ID = "ForegroundServiceChannel";
    ArrayList<String> tableList = new ArrayList<String>();
    int tableIndex=0;
    public static void setOnProgressChangedListener(com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh.OnProgressUpdateListener _listener) {
    ...
    public void downloadAppdata(){
        ...
        RequestQueue queue = Volley.newRequestQueue(com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh.this);
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject responseString) {
                        ...
                        if(response.equalsIgnoreCase("success")){
                            ...
                            Toast.makeText(com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh.this, "download failed", Toast.LENGTH_SHORT).show();
                        }
...
/*    sr.setRetryPolicy(new DefaultRetryPolicy(DefaultRetryPolicy.DEFAULT_TIMEOUT_MS,
    ...
    private void publishResults() {
        Intent intent = new Intent("com.intuition.ivepos.DatabaseitemActivity.receiverapp");
    ...
    public void downloadAppdataitems(final String table){
        Log.e("MyServiceApp_swiperefresh",getString(R.string.Button9));
        ...
        if(queue==null){
            queue = Volley.newRequestQueue(com.intuition.ivepos.syncdb.MyServiceApp_swiperefresh.this);
        }
        ...
        JsonObjectRequest sr = new JsonObjectRequest(
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject responseString) {
                        Log.e("MyServiceApp_swiperefresh",getString(R.string.Button10));
                        String response= "";
                        JSONObject jsonObject=null;
                        try {
                            jsonObject=responseString;
                        ...
                        if(response.equalsIgnoreCase("success")){
                            ...
                            if(tableIndex<tableList.size()){
                                ...
                                Log.e("MyServiceApp_swiperefresh","publishresults");
                                publishResults();
                                stopSelf();
                            }
...
/*    sr.setRetryPolicy(new DefaultRetryPolicy(DefaultRetryPolicy.DEFAULT_TIMEOUT_MS,
    ...
    public void parseJsonItems(JSONObject jsonObject,String table){
        ...
        Log.e("MyServiceApp_swiperefresh",getString(R.string.Button11));
        db = openOrCreateDatabase("mydb_Appdata", Context.MODE_PRIVATE, null);
        try {
            JSONArray jsonArray=jsonObject.getJSONArray("appdata");
            for(int i=0;i<jsonArray.length();i++){
