...
public class Yahoo_attachment_GenOrderlist1 {
    ...
    public Yahoo_attachment_GenOrderlist1() {

    }

    public Yahoo_attachment_GenOrderlist1(String fromEmail, String fromPassword,
