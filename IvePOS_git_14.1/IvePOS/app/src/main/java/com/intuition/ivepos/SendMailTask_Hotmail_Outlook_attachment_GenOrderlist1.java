...
public class SendMailTask_Hotmail_Outlook_attachment_GenOrderlist1 extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Hotmail_Outlook_attachment_GenOrderlist1(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Hotmail_Outlook_attachment_Genorderlist1 androidEmail = new Hotmail_Outlook_attachment_Genorderlist1(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
