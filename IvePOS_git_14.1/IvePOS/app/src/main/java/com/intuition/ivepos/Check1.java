...
//                    //Toast.makeText(Check.this, " "+String.valueOf(cou1), Toast.LENGTH_SHORT).show();
...
//                    //Toast.makeText(Check.this, " "+String.valueOf(cou), Toast.LENGTH_SHORT).show();
...
//                        if (news == 0){
//                            //Toast.makeText(Check.this, "limit is b " + limit, Toast.LENGTH_SHORT).show();
//                        }else {
