...
public class Office365_attachment_Productlist {
    ...
    public Office365_attachment_Productlist() {

    }

    public Office365_attachment_Productlist(String fromEmail, String fromPassword,
