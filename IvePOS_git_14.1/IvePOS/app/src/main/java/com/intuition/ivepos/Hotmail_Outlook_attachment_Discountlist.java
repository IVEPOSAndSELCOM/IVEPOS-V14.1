...
public class Hotmail_Outlook_attachment_Discountlist {
    ...
    public Hotmail_Outlook_attachment_Discountlist() {

    }

    public Hotmail_Outlook_attachment_Discountlist(String fromEmail, String fromPassword,
...
//        String filename = "sdcard/Download/IvePOS_items_report"+currentDateandTimee1+"_"+timee1+".csv";
        String filename = "sdcard/IVEPOS_reports/IVEPOS_discount_list/IvePOS_discount_list"+currentDateandTimee1+"_"+timee1+".csv";
