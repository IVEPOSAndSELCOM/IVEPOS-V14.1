...
public class ImageCursorAdapter_Inventory_Itemslist extends SimpleCursorAdapter {
    ...
    public ImageCursorAdapter_Inventory_Itemslist(Context context, int layout, Cursor c, String[] from, int[] to) {
