...
public class AppHelper_Retail {
    ...
    private static AppHelper_Retail appHelper_retail;
    ...
    /**
     * AddActivity your pool id here
     */

    private static final String userPoolId = "  ap-south-1_Tk1G9PqME";
    /**
     * AddActivity you app id
     */
    /**
     * AddActivity you app id
     */
    private static final String clientId = "3p51mrpo65bmhn1oni9a1otrgv";
     ...
     */
    private static final String clientSecret = "1egalc2udqdiub2t7812uaovbhub2hp7gfs520pvsarfgb4e0ajn";
    ...
    public static void init(Context context) {
        ...
        if (appHelper_retail != null && userPool != null) {
            return;
        }

        if (appHelper_retail == null) {
            appHelper_retail = new AppHelper_Retail();
        }
...
//
        ...
        attributeDisplaySeq.add("family_name");
        attributeDisplaySeq.add("nickname");
        attributeDisplaySeq.add("company_name");
        attributeDisplaySeq.add("email");
        attributeDisplaySeq.add("street_name");
        attributeDisplaySeq.add("area_name");
        attributeDisplaySeq.add("city_name");
        ...
        signUpFieldsC2O.put("Company name","company_name");
        signUpFieldsC2O.put("Email verified", "email_verified");
        signUpFieldsC2O.put("Email", "email");
        signUpFieldsC2O.put("Street name", "street_name");
        signUpFieldsC2O.put("Area name", "area_name");
        signUpFieldsC2O.put("City name", "city_name");
        ...
        signUpFieldsO2C.put("company_name", "Company name");
        signUpFieldsO2C.put("email_verified", "Email verified");
        signUpFieldsO2C.put("email", "Email");
        signUpFieldsO2C.put("street_name", "Street name");
        signUpFieldsO2C.put("area_name", "Area name");
        signUpFieldsO2C.put("city_name", "City name");
