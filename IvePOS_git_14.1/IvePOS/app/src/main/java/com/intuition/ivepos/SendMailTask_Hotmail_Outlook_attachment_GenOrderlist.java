...
public class SendMailTask_Hotmail_Outlook_attachment_GenOrderlist extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Hotmail_Outlook_attachment_GenOrderlist(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Hotmail_Outlook_attachment_Genorderlist androidEmail = new Hotmail_Outlook_attachment_Genorderlist(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
