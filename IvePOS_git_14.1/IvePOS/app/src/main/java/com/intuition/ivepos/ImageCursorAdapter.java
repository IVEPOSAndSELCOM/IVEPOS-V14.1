...
public class ImageCursorAdapter extends SimpleCursorAdapter {
    ...
    public ImageCursorAdapter(Context context, int layout, Cursor c, String[] from, int[] to, String insert1_cc) {
    ...
    public View getView(int pos, View inView, ViewGroup parent) {
        ...
        de.hdodenhof.circleimageview.CircleImageView iv = (de.hdodenhof.circleimageview.CircleImageView) v.findViewById(R.id.imageView13);
