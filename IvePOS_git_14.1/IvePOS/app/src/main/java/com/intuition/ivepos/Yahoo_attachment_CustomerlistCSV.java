...
public class Yahoo_attachment_CustomerlistCSV {
    ...
    public Yahoo_attachment_CustomerlistCSV() {

    }

    public Yahoo_attachment_CustomerlistCSV(String fromEmail, String fromPassword,
