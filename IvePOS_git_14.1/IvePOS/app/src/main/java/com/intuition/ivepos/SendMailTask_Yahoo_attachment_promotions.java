...
public class SendMailTask_Yahoo_attachment_promotions extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Yahoo_attachment_promotions(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Yahoo_attachment_promotions androidEmail = new Yahoo_attachment_promotions(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
                    args[4].toString());
