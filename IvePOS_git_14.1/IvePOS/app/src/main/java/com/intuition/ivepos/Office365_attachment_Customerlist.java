...
public class Office365_attachment_Customerlist {
    ...
    public Office365_attachment_Customerlist() {

    }

    public Office365_attachment_Customerlist(String fromEmail, String fromPassword,
