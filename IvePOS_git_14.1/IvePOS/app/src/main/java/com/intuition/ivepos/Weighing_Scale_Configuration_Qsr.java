...
public class Weighing_Scale_Configuration_Qsr extends AppCompatActivity implements BLEControllerCallback
{
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        DevicesListM.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                BLEController TheBleControllerL = BeveragesMenuFragment_Qsr.BLEControllerM;
                TheBleControllerL.ConnectToDevice(DeviceNameL, true);

                Toast.makeText(Weighing_Scale_Configuration_Qsr.this, " "+DeviceNameL, Toast.LENGTH_LONG).show();
...
//        Intent intent = new Intent(this, BeveragesMenuFragment_Qsr.class);
