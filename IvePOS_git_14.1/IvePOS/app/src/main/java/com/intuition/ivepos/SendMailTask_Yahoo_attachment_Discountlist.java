...
public class SendMailTask_Yahoo_attachment_Discountlist extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Yahoo_attachment_Discountlist(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Yahoo_attachment_Discountlist androidEmail = new Yahoo_attachment_Discountlist(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
