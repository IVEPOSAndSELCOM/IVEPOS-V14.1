 ...
 * Created by Rohithkumar on 1/6/2015.
 */
public class IngredientMenuFragment extends Fragment {
...
//        final ActionBar actionBar = getActivity().getActionBar();
        View view = inflater.inflate(R.layout.databaselayout , container, false);
        ...
        if (username.toString().equals(username1) || username.toString().equals(username11)){
            Intent intent = new Intent(getActivity(), Add_manage_ingredient_Activity.class);
            startActivity(intent);

        }else {
            Cursor cursor = db.rawQuery("SELECT * FROM User_privilege WHERE username = '"+username+"'", null);
            if (cursor.moveToFirst()){
                String pt = cursor.getString(8);
        ...
        btndatabase.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.toString().equals(username1) || username.toString().equals(username11)){
                    ...
                    hideKeyboard(getContext());
                    fragTransaction = getFragmentManager().beginTransaction().replace(R.id.container, frag,"DatabaseActivity");
                    fragTransaction.commit();
                    donotshowKeyboard(getActivity());
