...
public class Office365_attachment_Discountlist {
    ...
    public Office365_attachment_Discountlist() {

    }

    public Office365_attachment_Discountlist(String fromEmail, String fromPassword,
