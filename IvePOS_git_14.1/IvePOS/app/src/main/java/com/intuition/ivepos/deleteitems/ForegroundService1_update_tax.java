...
public class ForegroundService1_update_tax extends Service {
    public static final String CHANNEL_ID = "ForegroundService1_update_tax_Channel";
...
//            }
    ...
    public void deleteItem(String an){
        ...
        SharedPreferences sharedpreferences =  getDefaultSharedPreferencesMultiProcess(ForegroundService1_update_tax.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(ForegroundService1_update_tax.this);
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject responseString) {
                        ...
                        if(response.equalsIgnoreCase("success")){
                            ...
                            Toast.makeText(ForegroundService1_update_tax.this, "delete failed", Toast.LENGTH_SHORT).show();
                        }
