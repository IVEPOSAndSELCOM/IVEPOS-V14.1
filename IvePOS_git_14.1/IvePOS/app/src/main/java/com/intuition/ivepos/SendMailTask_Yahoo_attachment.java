...
public class SendMailTask_Yahoo_attachment extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Yahoo_attachment(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Yahoo_attachment androidEmail = new Yahoo_attachment(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
