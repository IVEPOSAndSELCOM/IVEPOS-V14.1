...
public class Hotmail_Outlook_attachment_Productlist {
    ...
    public Hotmail_Outlook_attachment_Productlist() {

    }

    public Hotmail_Outlook_attachment_Productlist(String fromEmail, String fromPassword,
