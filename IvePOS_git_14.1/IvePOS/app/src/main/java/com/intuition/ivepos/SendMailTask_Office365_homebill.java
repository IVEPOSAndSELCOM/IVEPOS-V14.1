...
public class SendMailTask_Office365_homebill extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Office365_homebill(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Office365_homebill androidEmail = new Office365_homebill(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
