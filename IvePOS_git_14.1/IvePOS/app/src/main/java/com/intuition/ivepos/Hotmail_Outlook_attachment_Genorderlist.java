...
public class Hotmail_Outlook_attachment_Genorderlist {
    ...
    public Hotmail_Outlook_attachment_Genorderlist() {

    }

    public Hotmail_Outlook_attachment_Genorderlist(String fromEmail, String fromPassword,
