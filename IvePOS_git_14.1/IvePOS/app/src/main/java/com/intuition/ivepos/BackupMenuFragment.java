 ...
 * Created by Rohithkumar on 1/6/2015.
 */
public class BackupMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.backuplayout , container, false);
        ...
        final LinearLayout btnadmin = (LinearLayout)view.findViewById(R.id.buttonadmin);
        final LinearLayout btnuser = (LinearLayout)view.findViewById(R.id.buttonuser);
        final LinearLayout btndatabase = (LinearLayout)view.findViewById(R.id.buttondatabase);
        final LinearLayout btnorderlist = (LinearLayout)view.findViewById(R.id.buttonorderlist);
        final LinearLayout btnprefrence = (LinearLayout)view.findViewById(R.id.buttonpreference);
        final LinearLayout btnbackup = (LinearLayout)view.findViewById(R.id.buttonbackup);
        final LinearLayout btncustomer = (LinearLayout)view.findViewById(R.id.buttoncustomer);
        final LinearLayout btningredients = (LinearLayout)view.findViewById(R.id.buttoningredients);

        final ImageView imageadmin = (ImageView)view.findViewById(R.id.image_admin);
        final ImageView imageuser = (ImageView)view.findViewById(R.id.image_user);
        final ImageView imageproduct = (ImageView)view.findViewById(R.id.image_product);
        final ImageView imagereport = (ImageView)view.findViewById(R.id.image_report);
        final ImageView imagesettings = (ImageView)view.findViewById(R.id.image_settings);
        final ImageView imagebackup = (ImageView)view.findViewById(R.id.image_backup);
        final ImageView imagecustomer = (ImageView)view.findViewById(R.id.image_customer);
        final ImageView imageingredients = (ImageView)view.findViewById(R.id.image_ingredients);

        final TextView textadmin = (TextView)view.findViewById(R.id.text_admin);
        final TextView textuser = (TextView)view.findViewById(R.id.text_user);
        final TextView textproduct = (TextView)view.findViewById(R.id.text_product);
        final TextView textreport = (TextView)view.findViewById(R.id.text_report);
        final TextView textsettings = (TextView)view.findViewById(R.id.text_settings);
        final TextView textbackup = (TextView)view.findViewById(R.id.text_backup);
        final TextView textcustomer = (TextView)view.findViewById(R.id.text_customer);
        final TextView textingredients = (TextView)view.findViewById(R.id.text_ingredients);
            ...
            public void onClick(View v) {
                ...
                if (username.toString().equals(username1) || username.toString().equals(username11)){
                    ...
                    if (getActivity() instanceof AppCompatActivity){
                        androidx.appcompat.app.ActionBar actionbar = ((AppCompatActivity) getActivity()).getSupportActionBar();
                        actionbar.setTitle("Control panel");
                        actionbar.setSubtitle(getString(R.string.action_user));
                    }
            ...
            public void onClick(View v) {
                ...
                if (username.toString().equals(username1) || username.toString().equals(username11)){
                    ...
                    if (getActivity() instanceof AppCompatActivity){
                        ...
                        actionbar.setSubtitle(getString(R.string.action_item));
                    }
            ...
            public void onClick(View v) {
                ...
                if (username.toString().equals(username1) || username.toString().equals(username11)){
                    ...
                    if (getActivity() instanceof AppCompatActivity){
                        ...
                        actionbar.setSubtitle(getString(R.string.Sales));
                    }
            ...
            public void onClick(View v) {
                ...
                if (username.toString().equals(username1) || username.toString().equals(username11)){
                    ...
                    if (getActivity() instanceof AppCompatActivity){
                        ...
                        actionbar.setSubtitle(getString(R.string.pref_header_general));
                    }
                            ...
                            if (cursor.moveToFirst()) {
                                ...
                                if (status.toString().equals("yes")) {
                                    ...
                                    if (getActivity() instanceof AppCompatActivity){
                                        androidx.appcompat.app.ActionBar actionbar = ((AppCompatActivity) getActivity()).getSupportActionBar();
                                        actionbar.setTitle(getString(R.string.title_activity_settings));
                                        actionbar.setSubtitle(getString(R.string.action_general_pref));
                                    }
...
//                                Toast.makeText(getActivity(), "hiiii", Toast.LENGTH_SHORT).show();
        ...
        btningredients.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, getString(R.string.dialog_action_dismiss),
