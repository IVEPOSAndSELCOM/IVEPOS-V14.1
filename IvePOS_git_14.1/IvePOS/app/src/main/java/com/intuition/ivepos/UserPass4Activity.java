 ...
 * Created by Rohithkumar on 1/6/2015.
 */
public class UserPass4Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.user_chg_pwd4, container, false);

        if (getActivity() instanceof AppCompatActivity){
            androidx.appcompat.app.ActionBar actionbar = ((AppCompatActivity) getActivity()).getSupportActionBar();
            actionbar.setSubtitle("User 4");
        }

        //actionBar.setTitle("User 4 - Control Panel");
...
//                fragTransaction.commit();
        ...
        db = getActivity().openOrCreateDatabase("mydb_Appdata", Context.MODE_PRIVATE,null);
        Cursor access = db.rawQuery("SELECT * FROM User4 ", null);
        if (access.moveToFirst()) {
            do {
...
//                    db.update("User4", contentValues, where1, new String[]{});
