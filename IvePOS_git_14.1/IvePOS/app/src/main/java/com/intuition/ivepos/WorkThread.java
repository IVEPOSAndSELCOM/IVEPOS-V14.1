...
public class WorkThread extends Thread {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Global.MSG_WORKTHREAD_HANDLER_CONNECTUSB: {
                    ...
                    USBDriver.USBPort port = (USBDriver.USBPort) data.getParcelable(Global.PARCE1);
                    PL2303Driver.TTYTermios serial = (PL2303Driver.TTYTermios) data
    ...
    public void connectUsb(USBDriver.USBPort port, PL2303Driver.TTYTermios serial) {
        if ((null != workHandler) && (null != mLooper)) {
            Message msg = workHandler
