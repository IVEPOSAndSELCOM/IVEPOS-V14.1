...
public class NewDeviceActivity_OTP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedpreferences_select =  SplashScreenActivity_Selection.getDefaultSharedPreferencesMultiProcess(NewDeviceActivity_OTP.this);
        ...
        tv_signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(et_device.getText().toString().length()==0){
                    ...
                    Toast.makeText(NewDeviceActivity_OTP.this, "Please select the store", Toast.LENGTH_SHORT).show();
                }else{
                    newdevice();
                }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if(response.equalsIgnoreCase("success")){
                            ...
                            Intent intent = new Intent(NewDeviceActivity_OTP.this, DownloadService.class);
