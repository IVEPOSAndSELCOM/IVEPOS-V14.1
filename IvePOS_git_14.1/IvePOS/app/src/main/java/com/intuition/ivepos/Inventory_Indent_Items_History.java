...
/**
 * Created by Rohithkumar on 9/7/2017.
 */

public class Inventory_Indent_Items_History extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inventory_indent_items_history);
        ...
        editText1_filter = new TextView(Inventory_Indent_Items_History.this);
        editText2_filter = new TextView(Inventory_Indent_Items_History.this);

        editText1_filter_df = new TextView(Inventory_Indent_Items_History.this);
        editText2_filter_df = new TextView(Inventory_Indent_Items_History.this);
...
//                    Toast.makeText(Inventory_Indent_Items_History.this, "2 "+tot, Toast.LENGTH_SHORT).show();
        ...
        filter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog dialog_filter = new Dialog(Inventory_Indent_Items_History.this, R.style.timepicker_date_dialog);
                ...
                editText11_df.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dpd.show(Inventory_Indent_Items_History.this.getFragmentManager(), "Datepickerdialog");
                ...
                editText_from_day_visible_df.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        android.app.TimePickerDialog timePickerDialog = new android.app.TimePickerDialog(Inventory_Indent_Items_History.this, R.style.timepicker_date_dialog, timePickerListener_open_df, hour, minute,
                                false);
                ...
                editText_to_day_visible_df.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        android.app.TimePickerDialog timePickerDialog = new android.app.TimePickerDialog(Inventory_Indent_Items_History.this, R.style.timepicker_date_dialog, timePickerListener_close_df, hour, minute,
                                false);
...
//                            date1 = editText1_filter.getText().toString();
//                            date2 = editText2_filter.getText().toString();
//                            Toast.makeText(Inventory_Indent_Items_History.this, "1 " + editText1_filter.getText().toString(), Toast.LENGTH_SHORT).show();
//                            Toast.makeText(Inventory_Indent_Items_History.this, "2 " + editText2_filter.getText().toString(), Toast.LENGTH_SHORT).show();
...
//                            Toast.makeText(Inventory_Indent_Items_History.this, "3 " + editText1_filter.getText().toString(), Toast.LENGTH_SHORT).show();
//                            Toast.makeText(Inventory_Indent_Items_History.this, "4 " + editText2_filter.getText().toString(), Toast.LENGTH_SHORT).show();
...
//                            Toast.makeText(Inventory_Indent_Items_History.this, "4 " + editText2_filter_df.getText().toString(), Toast.LENGTH_SHORT).show();
                            ...
                            Cursor ones = db.rawQuery("SELECT * FROM Vendor_sold_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' GROUP BY vendor_phoneno", null);
                            int cou = ones.getCount();
                            String ttotal1 = String.valueOf(cou);
                            no_of_vendors.setText(ttotal1);
...
//                    Toast.makeText(getActivity(),"time is "+time_hide, Toast.LENGTH_SHORT).show();
                            ...
                            float co1 = 0;
                            Cursor cursorq1 = db.rawQuery("SELECT * FROM Vendor_sold_details GROUP BY datetimee_new_from", null);
                            if (cursorq1.moveToFirst()){
                                do {
                                    String dateti = cursorq1.getString(13);
//                                    Toast.makeText(Inventory_Indent_Items_History.this, "1 "+dateti, Toast.LENGTH_SHORT).show();

                                    Cursor cursorq2 = db.rawQuery("SELECT * FROM Vendor_sold_details WHERE datetimee_new_from = '"+dateti+"'", null);
...
//                                        Toast.makeText(Inventory_Indent_Items_History.this, "2 "+tot, Toast.LENGTH_SHORT).show();
        ...
        list_items.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                final Dialog dialog1 = new Dialog(Inventory_Indent_Items_History.this, R.style.timepicker_date_dialog);
                ...
                Cursor cursora = db.rawQuery("SELECT COUNT(itemname) FROM Vendor_sold_item_details WHERE itemname = '"+c_ItemID+"'", null);
                if (cursora.moveToFirst()){
                    int a = cursora.getInt(0);
                    total_listings.setText(String.valueOf(a));
                }

                Cursor cursor = db.rawQuery("SELECT * FROM Vendor_sold_item_details WHERE itemname = '"+c_ItemID+"'", null);
...
//                    Toast.makeText(Inventory_Indent_Items_History.this, "working hours", Toast.LENGTH_LONG).show();
                    ...
                    Cursor cursorq = db.rawQuery("SELECT * FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter.getText().toString()+"' AND itemname = '"+c_ItemID+"'", null);
                    String[] fromFieldNames = {"from_date", "from_time", "vendor_name", "qty_add", "individual_price", "total_price", "total_price", "total_price"};
                    int[] toViewsID = {R.id.item_date, R.id.item_time, R.id.vendor_name, R.id.item_qty, R.id.item_indiv_price, R.id.item_total_price, R.id.x1, R.id.x2};
                    ddataAdapterr = new SimpleCursorAdapter(Inventory_Indent_Items_History.this, R.layout.dialog_inventory_indent_items_listview, cursorq, fromFieldNames, toViewsID, 0);
//                    dialog_list_items.setAdapter(ddataAdapterr);

                    ddataAdapterr.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
                        @Override
                        public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                            if (view.getId() == R.id.x1 || view.getId() == R.id.x2) {
                    ...
                    Cursor cursoraf = db.rawQuery("SELECT COUNT(itemname) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter.getText().toString()+"' AND itemname = '"+c_ItemID+"'", null);
                ...
                if (sel == 2){
                    dialog_list_items.setAdapter(null);
//                    Toast.makeText(Inventory_Indent_Items_History.this, "custom time", Toast.LENGTH_LONG).show();

                    Cursor cursorq = db.rawQuery("SELECT * FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' AND itemname = '"+c_ItemID+"'", null);
                    String[] fromFieldNames = {"from_date", "from_time", "vendor_name", "qty_add", "individual_price", "total_price", "total_price", "total_price"};
                    int[] toViewsID = {R.id.item_date, R.id.item_time, R.id.vendor_name, R.id.item_qty, R.id.item_indiv_price, R.id.item_total_price, R.id.x1, R.id.x2};
                    ddataAdapterr = new SimpleCursorAdapter(Inventory_Indent_Items_History.this, R.layout.dialog_inventory_indent_items_listview, cursorq, fromFieldNames, toViewsID, 0);
//                    dialog_list_items.setAdapter(ddataAdapterr);
                    ...
                    Cursor cursoraf = db.rawQuery("SELECT COUNT(itemname) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' AND itemname = '"+c_ItemID+"'", null);
                    if (cursoraf.moveToFirst()){
                        int a = cursoraf.getInt(0);
                        total_listings.setText(String.valueOf(a));
                    }
                ...
                if (sel == 3){
                    dialog_list_items.setAdapter(null);
//                    Toast.makeText(Inventory_Indent_Items_History.this, "all time", Toast.LENGTH_LONG).show();

                    Cursor cursorq = db.rawQuery("SELECT * FROM Vendor_sold_item_details WHERE itemname = '"+c_ItemID+"'", null);
                    String[] fromFieldNames = {"from_date", "from_time", "vendor_name", "qty_add", "individual_price", "total_price", "total_price", "total_price"};
                    int[] toViewsID = {R.id.item_date, R.id.item_time, R.id.vendor_name, R.id.item_qty, R.id.item_indiv_price, R.id.item_total_price, R.id.x1, R.id.x2};
                    ddataAdapterr = new SimpleCursorAdapter(Inventory_Indent_Items_History.this, R.layout.dialog_inventory_indent_items_listview, cursorq, fromFieldNames, toViewsID, 0);
//                    dialog_list_items.setAdapter(ddataAdapterr);
    ...
    class DownloadMusicfromInternet extends AsyncTask<Void, Integer, Void> {
        private ProgressDialog dialog = new ProgressDialog(Inventory_Indent_Items_History.this, R.style.timepicker_date_dialog);
...
//            db.delete("Items_temp_list", null, null);
...
//                    Log.v("barcode", barcode);
                    ...
                    Cursor cursor11 = db.rawQuery("SELECT * FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter.getText().toString()+"' AND itemname = '"+item_na+"'", null);
                    if (cursor11.moveToFirst()) {

                        ContentValues contentValues = new ContentValues();

                        contentValues.put("itemname", item_na);
                        Cursor cursor1 = db.rawQuery("SELECT SUM(total_price) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                        if (cursor1.moveToFirst()) {
                            float a = cursor1.getFloat(0);

                            Cursor cursor2 = db.rawQuery("SELECT SUM(qty_add) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                            if (cursor2.moveToFirst()) {
                        ...
                        Cursor cursor2 = db.rawQuery("SELECT MIN(individual_price) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                        if (cursor2.moveToFirst()) {
                        ...
                        Cursor cursor3 = db.rawQuery("SELECT MAX(individual_price) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                        ...
                        Cursor cursor4 = db.rawQuery("SELECT SUM(qty_add) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                        ...
                        Cursor cursor5 = db.rawQuery("SELECT SUM(total_price) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter.getText().toString()+"' AND itemname = '" + item_na + "'", null);
...
//                        Log.v("barcode1", barcode);
                        ...
                        getContentResolver().notifyChange(resultUri, null);
//                        db.insert("Items_temp_list", null, contentValues);
...
//            });
        ...
        protected void onPostExecute(Void result) {
            ...
            Cursor cursor = db.rawQuery("SELECT * FROM Items_temp_list WHERE total_price != '0' OR total_price != '0.0'", null);
            String[] fromFieldNames = {"itemname", "avg_price", "min_price", "max_price", "total_qty", "total_price", "total_price", "total_price", "total_price", "total_price"};
            int[] toViewsID = {R.id.itemname, R.id.avg_price, R.id.min_price, R.id.max_price, R.id.total_qty, R.id.total_price, R.id.inn, R.id.inn1, R.id.inn2, R.id.inn3};
            ddataAdapterr = new SimpleCursorAdapter(Inventory_Indent_Items_History.this, R.layout.inventory_indent_items_history_listview, cursor, fromFieldNames, toViewsID, CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
//            list_items.setAdapter(ddataAdapterr);
            ddataAdapterr.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
                @Override
                public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                    if (view.getId() == R.id.inn || view.getId() == R.id.inn1 || view.getId() == R.id.inn2 || view.getId() == R.id.inn3) {
                        final String tadl_id = cursor_country1.getString(cursor_country1.getColumnIndex("country"));
                        TextView dateTextView = (TextView) view;
                        if (tadl_id.toString().equals("India")){
                            dateTextView.setText(insert1_cc);
...
//                    Log.v("barcode", barcode);
                    ...
                    Cursor cursor11 = db.rawQuery("SELECT * FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' AND itemname = '"+item_na+"'", null);
                    if (cursor11.moveToFirst()) {

                        ContentValues contentValues = new ContentValues();

                        contentValues.put("itemname", item_na);
                        Cursor cursor1 = db.rawQuery("SELECT SUM(total_price) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                        if (cursor1.moveToFirst()) {
                            float a = cursor1.getFloat(0);

                            Cursor cursor2 = db.rawQuery("SELECT SUM(qty_add) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                            if (cursor2.moveToFirst()) {
                                int a1 = cursor2.getInt(0);
                        ...
                        Cursor cursor2 = db.rawQuery("SELECT MIN(individual_price) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                        if (cursor2.moveToFirst()) {
                            float one11 = cursor2.getFloat(0);
                            contentValues.put("min_price", String.format("%.1f", one11));
                        }
                        ...
                        Cursor cursor3 = db.rawQuery("SELECT MAX(individual_price) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                        if (cursor3.moveToFirst()) {
                            float one11 = cursor3.getFloat(0);
                            contentValues.put("max_price", String.format("%.1f", one11));
                        }
                        ...
                        Cursor cursor4 = db.rawQuery("SELECT SUM(qty_add) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                        if (cursor4.moveToFirst()) {
                            float one11 = cursor4.getFloat(0);
                            contentValues.put("total_qty", String.format("%.1f", one11));
                        }
                        ...
                        Cursor cursor5 = db.rawQuery("SELECT SUM(total_price) FROM Vendor_sold_item_details WHERE datetimee_new_from >= '"+editText1_filter_df.getText().toString()+"' AND datetimee_new_from <='"+editText2_filter_df.getText().toString()+"' AND itemname = '" + item_na + "'", null);
                        if (cursor5.moveToFirst()) {
                            float one11 = cursor5.getFloat(0);
                            contentValues.put("total_price", String.format("%.1f", one11));
                        }
...
//            });
        ...
        protected void onPostExecute(Void result) {
            ...
            String[] fromFieldNames = {"itemname", "avg_price", "min_price", "max_price", "total_qty", "total_price", "total_price", "total_price", "total_price", "total_price"};
            int[] toViewsID = {R.id.itemname, R.id.avg_price, R.id.min_price, R.id.max_price, R.id.total_qty, R.id.total_price, R.id.inn, R.id.inn1, R.id.inn2, R.id.inn3};
            ddataAdapterr = new SimpleCursorAdapter(Inventory_Indent_Items_History.this, R.layout.inventory_indent_items_history_listview, cursor, fromFieldNames, toViewsID, 0);
//            list_items.setAdapter(ddataAdapterr);
            ddataAdapterr.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
                @Override
                public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
...
//                    Log.v("barcode", barcode);
                    ...
                    Cursor cursor11 = db.rawQuery("SELECT * FROM Vendor_sold_item_details WHERE itemname = '"+item_na+"'", null);
                    if (cursor11.moveToFirst()) {

                        ContentValues contentValues = new ContentValues();

                        contentValues.put("itemname", item_na);
                        Cursor cursor1 = db.rawQuery("SELECT SUM(total_price) FROM Vendor_sold_item_details WHERE itemname = '" + item_na + "'", null);
                        if (cursor1.moveToFirst()) {
                            float a = cursor1.getFloat(0);

                            Cursor cursor2 = db.rawQuery("SELECT SUM(qty_add) FROM Vendor_sold_item_details WHERE itemname = '" + item_na + "'", null);
                            if (cursor2.moveToFirst()) {
                                int a1 = cursor2.getInt(0);
                        ...
                        Cursor cursor2 = db.rawQuery("SELECT MIN(individual_price) FROM Vendor_sold_item_details WHERE itemname = '" + item_na + "'", null);
                        if (cursor2.moveToFirst()) {
                            float one11 = cursor2.getFloat(0);
                            contentValues.put("min_price", String.format("%.1f", one11));
                        }
                        ...
                        Cursor cursor3 = db.rawQuery("SELECT MAX(individual_price) FROM Vendor_sold_item_details WHERE itemname = '" + item_na + "'", null);
                        if (cursor3.moveToFirst()) {
                            float one11 = cursor3.getFloat(0);
                            contentValues.put("max_price", String.format("%.1f", one11));
                        }
                        ...
                        Cursor cursor4 = db.rawQuery("SELECT SUM(qty_add) FROM Vendor_sold_item_details WHERE itemname = '" + item_na + "'", null);
                        if (cursor4.moveToFirst()) {
                            float one11 = cursor4.getFloat(0);
                            contentValues.put("total_qty", String.format("%.1f", one11));
                        }
                        ...
                        Cursor cursor5 = db.rawQuery("SELECT SUM(total_price) FROM Vendor_sold_item_details WHERE itemname = '" + item_na + "'", null);
                        if (cursor5.moveToFirst()) {
                            float one11 = cursor5.getFloat(0);
                            contentValues.put("total_price", String.format("%.1f", one11));
                        }
...
//            list_items.setAdapter(ddataAdapterr);
    ...
    public Cursor fetchCountriesByName1(String inputtext) throws SQLException {
        ...
        if (inputtext == null  ||  inputtext.length () == 0)  {
            mCursor = db.rawQuery("SELECT * FROM Items_temp_list", null);

        }
        else {
            mCursor = db.rawQuery("SELECT * FROM Items_temp_list WHERE itemname LIKE '%" + inputtext + "%' OR barcode LIKE '%" + inputtext + "%'", null);
        }
