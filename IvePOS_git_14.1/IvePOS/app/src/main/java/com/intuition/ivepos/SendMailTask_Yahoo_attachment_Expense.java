...
public class SendMailTask_Yahoo_attachment_Expense extends AsyncTask {

    private ProgressDialog statusDialog;
    private Activity sendMailActivity;

    public SendMailTask_Yahoo_attachment_Expense(Activity activity) {
    ...
    protected Object doInBackground(Object... args) {
        try {
            ...
            Yahoo_attachment_Expense androidEmail = new Yahoo_attachment_Expense(args[0].toString(),
                    args[1].toString(),
                    (List) args[2],
                    args[3].toString(),
