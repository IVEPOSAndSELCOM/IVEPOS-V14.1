...
public class Hotmail_Outlook_attachment_Taxlist {
    ...
    public Hotmail_Outlook_attachment_Taxlist() {

    }

    public Hotmail_Outlook_attachment_Taxlist(String fromEmail, String fromPassword,
...
//        String filename = "sdcard/Download/IvePOS_items_report"+currentDateandTimee1+"_"+timee1+".csv";
        String filename = "sdcard/IVEPOS_reports/IVEPOS_Taxwise_report/IvePOS_Taxwise_report"+currentDateandTimee1+"_"+timee1+".csv";
