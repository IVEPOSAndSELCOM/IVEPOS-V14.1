...
public class User_cancel_kot_list extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_cancel_kot_listview);
        ...
        TextView editText1_filter = new TextView(User_cancel_kot_list.this);
        TextView editText2_filter = new TextView(User_cancel_kot_list.this);
        TextView editText1 = new TextView(User_cancel_kot_list.this);
        TextView editText11 = new TextView(User_cancel_kot_list.this);
        TextView editText2 = new TextView(User_cancel_kot_list.this);
        TextView editText22 = new TextView(User_cancel_kot_list.this);
        TextView editText_from_day_visible = new TextView(User_cancel_kot_list.this);
        TextView editText_from_day_hide = new TextView(User_cancel_kot_list.this);
        TextView editText_to_day_visible = new TextView(User_cancel_kot_list.this);
        TextView editText_to_day_hide = new TextView(User_cancel_kot_list.this);
        ...
        SharedPreferences sharedpreferences_select =  SplashScreenActivity_Selection.getDefaultSharedPreferencesMultiProcess(User_cancel_kot_list.this);
        ...
        donotshowKeyboard(User_cancel_kot_list.this);
...
//                Toast.makeText(Category_list.this, onee.getText().toString(), Toast.LENGTH_LONG).show();
                ...
                Dialog dialog = new Dialog(User_cancel_kot_list.this, R.style.timepicker_date_dialog);
                dialog.setContentView(R.layout.dialog_user_cancel_kot);
                dialog.show();
                ...
                final String selectQuery = "SELECT * FROM Kotcancelled WHERE datetimee_new >= '"+player1name+"' AND datetimee_new <='"+player2name+"' AND user = '"+onee.getText().toString()+"'";
                ...
                SimpleCursorAdapter adapter = new SimpleCursorAdapter(User_cancel_kot_list.this, R.layout.dialog_user_cancel_kot_listview, cursor1, fromFieldNames, toViewsID, 0);
        ...
        user_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i ==1) {
                    ...
                    final String selectQuery = "SELECT * FROM dummy_user_kot ORDER BY user COLLATE NOCASE DESC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"user", "transactions", "amount"};
                    final int[] toViewsID = {R.id.user, R.id.no_of_transactions, R.id.amount};
                    SimpleCursorAdapter adapter = new SimpleCursorAdapter(User_cancel_kot_list.this, R.layout.user_cancel_kot_layout, cursor1, fromFieldNames, toViewsID, 0);
                    listView.setAdapter(adapter);
                    ...
                    final String selectQuery = "SELECT * FROM dummy_user_kot ORDER BY user COLLATE NOCASE ASC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"user", "transactions", "amount"};
                    final int[] toViewsID = {R.id.user, R.id.no_of_transactions, R.id.amount};
        ...
        transactions_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i ==1) {
                    ...
                    final String selectQuery = "SELECT * FROM dummy_user_kot ORDER BY CAST(transactions AS unsigned) DESC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"user", "transactions", "amount"};
                    final int[] toViewsID = {R.id.user, R.id.no_of_transactions, R.id.amount};
                    ...
                    final String selectQuery = "SELECT * FROM dummy_user_kot ORDER BY CAST(transactions AS unsigned) ASC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"user", "transactions", "amount"};
                    final int[] toViewsID = {R.id.user, R.id.no_of_transactions, R.id.amount};
        ...
        amount_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i ==1) {
                    ...
                    final String selectQuery = "SELECT * FROM dummy_user_kot ORDER BY CAST(amount AS unsigned) DESC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"user", "transactions", "amount"};
                    final int[] toViewsID = {R.id.user, R.id.no_of_transactions, R.id.amount};
                    ...
                    final String selectQuery = "SELECT * FROM dummy_user_kot ORDER BY CAST(amount AS unsigned) ASC";
                    Cursor cursor1 = db1.rawQuery(selectQuery, null);//replace to cursor = dbHelper.fetchAllHotels();
                    // The desired columns to be bound
                    final String[] fromFieldNames = {"user", "transactions", "amount"};
                    final int[] toViewsID = {R.id.user, R.id.no_of_transactions, R.id.amount};
    ...
    public ArrayList<String> getTableValuesall() {
        ...
        try {
            ...
            Toast.makeText(User_cancel_kot_list.this, "Error encountered.",
                    Toast.LENGTH_LONG);
        }
        return my_array;
    }
    ...
    public void webservicequery_sales(final String webserviceQuery){
        ...
        SharedPreferences sharedpreferences = getDefaultSharedPreferencesMultiProcess(User_cancel_kot_list.this);
        ...
        RequestQueue queue;
        StringRequest sr1;
        // queue = Volley.newRequestQueue(User_cancel_kot_list.this);

        queue= RequestSingleton.getInstance(User_cancel_kot_list.this).getInstance();
...
//                            final String pwd = prefs.getString("password", "");
    ...
    class DownloadMusicfromInternet1 extends AsyncTask<String, Void, Integer> {
        ...
        private ProgressDialog dialog = new ProgressDialog(User_cancel_kot_list.this, R.style.timepicker_date_dialog);
        ...
        protected Integer doInBackground(String... params) {
            ...
            final String selectQuery = "SELECT * FROM Kotcancelled WHERE datetimee_new >= '"+player1name+"' AND datetimee_new <='"+player2name+"' GROUP BY user";
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    Cursor cursor1 = db1.rawQuery("SELECT SUM(total) FROM Kotcancelled WHERE user = '"+category+"' AND datetimee_new >= '"+player1name+"' AND datetimee_new <='"+player2name+"' GROUP BY user", null);
                    if (cursor1.moveToFirst()) {
                        icount1 = cursor1.getFloat(0);
                    }
                    cursor1.close();

                    Cursor cursor2 = db1.rawQuery("SELECT Count(*) FROM Kotcancelled WHERE user = '"+category+"' AND datetimee_new >= '"+player1name+"' AND datetimee_new <='"+player2name+"' GROUP BY user", null);
                    ...
                    contentValues.put("user", category);
...
//            });
        ...
        protected void onPostExecute(Integer file_url) {
            ...
            final String selectQuery = "SELECT * FROM dummy_user_kot";
...
//                    ImageCursorAdapter_Category adapter = new ImageCursorAdapter_Category(Category_list.this, R.layout.user_cancel_kot_layout, cursor1, fromFieldNames, toViewsID, player1name, player2name);
//                    listView.setAdapter(adapter);
//                }
//            });
