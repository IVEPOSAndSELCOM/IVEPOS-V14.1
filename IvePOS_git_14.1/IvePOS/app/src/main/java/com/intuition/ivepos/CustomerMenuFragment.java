...
public class CustomerMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.customerlayout , container, false);
...
//            actionBar.setTitle("Settings");
            ...
            fragTransaction = getFragmentManager().beginTransaction().replace(R.id.container, frag,"CustomerActivity");
            fragTransaction.commit();
        }else {
            Cursor cursor = db.rawQuery("SELECT * FROM User_privilege WHERE username = '"+username+"'", null);
            if (cursor.moveToFirst()) {
                String pt = cursor.getString(7);
