...
public class ImageCursorAdapter_ST_rec extends SimpleCursorAdapter {

    private Cursor c;
    private Context context;
    public SQLiteDatabase db = null;

    public ImageCursorAdapter_ST_rec(Context context, int layout, Cursor c, String[] from, int[] to) {
    ...
    public View getView(int pos, View inView, ViewGroup parent) {
        ...
        String from_store = this.c.getString(this.c.getColumnIndex("from_store"));
        String from_device = this.c.getString(this.c.getColumnIndex("from_device"));
