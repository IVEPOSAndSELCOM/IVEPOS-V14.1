...
public class Hotmail_Outlook_attachment_Customerlist {
    ...
    public Hotmail_Outlook_attachment_Customerlist() {

    }

    public Hotmail_Outlook_attachment_Customerlist(String fromEmail, String fromPassword,
